...
import { fetchProperties } from "@/api/FetchProperty";
...
const PropertiesPage = (props: PropertyListPageProps) => {
  ...
  return (
    <div className="max-w-5xl mx-auto p-6">
      ...
      <SearchFilters initialProvince={props.province} onSearch={handleSearch} />
